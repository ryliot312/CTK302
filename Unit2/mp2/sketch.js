...
function draw() {
  ...
  switch (numberOfTouches) {
    ...
    case 1: //intro
      ...
      textSize(20);
      textAlign(LEFT);
      text("First, up we have the Nurse Shark! \nThey suck up their food and they can walk across the bottom floor.", 50, 50);
          ...
          background("blue"); textFont(f1); textSize(20); text("Second we have the Lemon Shark! \nThey can weight up to 551 pounds and they get their name from their brownish, yellow color.", 50, 50);
            ...
            background("blue"); textFont(f1); textSize(20); text("Third we have the Hammerhead shark!\n There are nine different species of hammerheads. It's favorite meal is stingrays.", 90, 90);
              ...
              case 4: //intro
              background("blue"); textFont(f1); textSize(20); text("Fourth, we have the Whale Shark! They can grow up to 40 feet long and they can weight up to 20 tons.", 90, 90);
                ...
                case 5: //intro
                background("blue"); textFont(f1); textSize(20); text("Lastly, we have the Great White Shark! Have their own fin prints and they are not the top of the food chain, surprisingly.", 90, 90);
